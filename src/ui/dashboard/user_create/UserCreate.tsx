...
export const DashboardUserCreatePage: FC<Props> = ({}) => {
    const {fetchList: fetchRoleList, fetchListState: fetchRoleListState, onFetchListStateReceived: onFetchRoleListStateReceived, roleList} = useRoleViewModel()
    ...
    useAppLoader([fetchRoleListState, createState])

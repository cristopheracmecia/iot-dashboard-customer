...
export const DashboardDeviceCreatePage: FC<Props> = ({}) => {
    const {fetchList: fetchUnitList, fetchListState: fetchUnitListState, onFetchListStateReceived: onFetchUnitListStateReceived, unitList} = useUnitViewModel()
    ...
    useAppLoader([fetchUnitListState, createDeviceState])
